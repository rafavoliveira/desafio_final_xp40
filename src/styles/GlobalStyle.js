...
export const Formulario = styled.div`
    ...
    max-width: 360px; margin: 0 auto 100px; padding: 45px; text-align: center; 
    box-shadow: 0 0 20px 0 rgba(0, 0, 0, 0.2), 0 5px 5px 0 rgba(0, 0, 0, 0.24);
`;
export const RegistroFormulario = styled.div`
    font-family: "Roboto", sans-serif; outline: 0; width: 100%;
    border: 0; margin: 0 0 15px; padding: 15px;
    box-sizing: border-box; font-size: 14px;
`;
export const InputFormulario = styled.input`
    font-family: "Roboto", sans-serif; outline: 0;
...
export const BotaoFormulario = styled.button`
    ...
    outline: 0; background: #0d6efd; width: 100%;
    border: 0; padding: 15px; color: #FFFFFF; font-size: 14px;
    -webkit-transition: all 0.3 ease; transition: all 0.3 ease;
    cursor: pointer;
`;